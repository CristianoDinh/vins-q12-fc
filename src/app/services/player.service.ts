...
export class PlayerService {
  ...
  protected playerList: Player[] = [
    ...
    // { id: 30, name: 'Quân Palmer', position: 'Forward', imgUrl: 'squad-1.png' },
    // { id: 31, name: 'Secrete', position: 'Goalkeeper', imgUrl: 'squad-1.png' },
    // { id: 32, name: 'Secrete', position: 'Goalkeeper', imgUrl: 'squad-1.png' },
    // { id: 33, name: 'Secrete', position: 'Goalkeeper', imgUrl: 'squad-1.png' }
  ];
